	...
	initComponent: function(){
		...
		Ext.apply(this, {
			...
			columns : [
				...
				{ text : 'BL/NO',							dataIndex : 'cr_blno',					width:150,				align:'left'	},
				{ text : '통관번호',						dataIndex : 'cr_refno',					width:150,				align:'left'	},
				{ text : '통관CNT',						dataIndex : 'CR_EA',						width:90,					align:'right'	},
				{ text : '입고CNT',						dataIndex : 'IP_EA',						width:90,					align:'right'	},
				{ text : '통관별칭',						dataIndex : 'cr_name',					width:150,				align:'left'	},
				{ text : '통관일',							dataIndex : 'cr_date',					sortable: true,		align:'center',		summaryType: 'max',						renderer: Ext.util.Format.dateRenderer('Y-m-d')	},
				...
				{ text : '담당자',							dataIndex : 'admin_id',					width:120,				align:'center'	}
			],
			tbar: [
	...
	initComponent: function(){
		...
		Ext.apply(this, {
			...
			columns : [
				...
				{ text : '환율(입고)',					dataIndex : 'wr_exchrate',			width:100,				align:'right',		editor: { allowBlank : false }	},
...
Ext.define('td.view.grid.InvoiceGpInfo',{
	...
	initComponent: function(){
		...
		Ext.apply(this, {
			...
			autoWidth : true,
			columns : [
				{ text : '공구명', 			width : 380,	dataIndex : 'gpcode_name',	align:'left',		sortable: false	},
				{ text : '공구코드',		width : 120,	dataIndex : 'gpcode',					align:'left',		hidden:true	},
				{ text : '날짜',				width : 120,	dataIndex : 'reg_date',				align:'left',		hidden:true	},
	...
	initComponent: function(){
		...
		Ext.apply(this, {
			...
			columns : [
				...
				{ text : '통관코드',			dataIndex : 'cr_id',								align:'left',			width:130,		hidden:true		},
				{ text : 'BL/NO',				dataIndex : 'cr_blno',							align:'left',			width:150	},
				{ text : '통관번호',			dataIndex : 'cr_refno',							align:'left',			width:150	},
				{ text : '발주코드',			dataIndex : 'iv_id',								align:'left',			width:120		},
				{ text : '인보이스번호',	dataIndex : 'iv_order_no',					align:'left',			width:120		},
				{	text : '현황',				dataIndex: 'iv_stats',								align:'center',		allowBlank: true,			editor: {xtype: 'cb_ivstats'},			value : '00',			renderer: rendererCombo	},
				{ text : '날짜',					dataIndex : 'reg_date',							align:'center',		sortable: true,		summaryType: 'max',		renderer: Ext.util.Format.dateRenderer('Y-m-d'),	summaryRenderer: Ext.util.Format.dateRenderer('Y-m-d'),		field: { xtype: 'datefield' },		hidden:true	},
				{ text : '공구코드',			dataIndex : 'gpcode',								align:'left',			hidden:true		},
				{ text : 'IMG', 				dataIndex : 'iv_it_img',						align:'center',		width:50,					renderer:rendererImage 		},
				{ text : '상품코드',			dataIndex : 'iv_it_id',							align:'left',			width:160		},
				{ text : '품목명',				dataIndex : 'iv_it_name',						align:'left',			width:450		},
				{ text : '통화',					dataIndex : 'money_type',						align:'center',		width:70		},
				{ text : '발주가(해외)',	dataIndex : 'iv_dealer_worldprice',	width:120,				editor: { allowBlank : false },			align:'right',	renderer: Ext.util.Format.numberRenderer('0,000.00') },
				{ text : '발주가(￦)',		dataIndex : 'iv_dealer_price',			editor: { allowBlank : false },			align:'right',	renderer: Ext.util.Format.numberRenderer('0,000'),	hidden:true },
				{ text : '주문집계',			dataIndex : 'SUM_QTY',																									align:'right',	renderer: Ext.util.Format.numberRenderer('0,000') },
				{ text : '발주수량',			dataIndex : 'iv_qty',								editor: { allowBlank : false },			align:'right',	renderer: Ext.util.Format.numberRenderer('0,000') },
				{ text : '통관수량',			dataIndex : 'cr_qty',								editor: { allowBlank : false },			align:'right',	renderer: Ext.util.Format.numberRenderer('0,000') },
				{ text : '취소수량',			dataIndex : 'cr_cancel_qty',				editor: { allowBlank : false },			align:'right',	renderer: Ext.util.Format.numberRenderer('0,000') }
			],
			tbar : [
				{
