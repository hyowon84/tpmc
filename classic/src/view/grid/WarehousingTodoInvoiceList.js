	...
	initComponent: function(){
		...
		Ext.apply(this, {
			...
			columns : [
				...
				{ text : '날짜',					dataIndex : 'reg_date',							align:'center',		summaryType: 'max',		renderer: Ext.util.Format.dateRenderer('Y-m-d'),	summaryRenderer: Ext.util.Format.dateRenderer('Y-m-d'),		hidden:true	},
				{ text : '공구코드',			dataIndex : 'gpcode',								align:'left',			sortable: true		},
