	...
	initComponent: function(){
		...
		Ext.apply(this, {
			...
			columns : [
				...
				{ text : '품목명',						dataIndex : 'it_name',							width:450,			style:'text-align:center',	align:'left' },
				...
				{ text : '관리자메모',				dataIndex : 'admin_memo',						width:150,			style:'text-align:center',	align:'left',		editor: { allowBlank : false }	}
			],
			tbar : [
				{	xtype: 'label',	text: '검색어 : ',		autoWidth:true,	style : 'font-weight:bold;'},
				{
