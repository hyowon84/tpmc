...
$v_sms = Array(	'10' => "[{주문ID}]금액:{주문금액}원, 우리은행 1005-503-165645 투데이주식회사",
								'20' => "주문번호{주문ID}의 입금이 확인되었습니다. -투데이주식회사",
								'25' => "주문번호{주문ID}의 상품은 10~15일후 배송예정입니다. -투데이주식회사",
								'30' => "주문번호{주문ID}의 상품은 방문전달할 예정입니다. -투데이주식회사",
								'35' => "주문번호{주문ID}의 상품은 고객님께서 방문수령할 예정입니다. -투데이주식회사",
								'40' => "{주문ID}의 상품은 익일 배송될 예정입니다(우체국:{운송장번호})-투데이주식회사",
								'90' => "주문번호{주문ID}에 대한 환불이 처리되었습니다 . -투데이주식회사",
								'400' => "주문하신 상품들은 익일 배송될 예정입니다(우체국:{운송장번호})-투데이주식회사",
);
